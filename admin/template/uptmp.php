...
<div id="layout">
        ...
        <div class="pure-menu" id="menu">
            <ul class="pure-menu-list" style="text-align: center">
               ...
               if($bddCo->logged == 1){
                    ...
                    echo '<li class="pure-menu-item pure-menu-selected"><a href="/admin/updates.php" class="pure-menu-link">Historique</a>';
    ...
    <div class="content">
    	<section class="chooseservice">
    		<form method="post" action="updates.php" class="pure-form">
                ...
                <input type="submit" class="pure-button pure-button-primary" value="Trier" name="triMit"/>
